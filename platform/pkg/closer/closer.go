// Package closer предоставляет механизм graceful shutdown для корректного завершения сервисов.
//
// Основные возможности:
// - Регистрация функций завершения с именами для отладки
// - Последовательное выполнение функций завершения с логированием
// - Поддержка контекста с таймаутами
// - Thread-safe операции для concurrent использования
// - Автоматическая обработка системных сигналов
// - Защита от паник в функциях завершения
//
...
// Logger интерфейс для логирования процесса завершения
...
// =============================================================================
// ОСНОВНАЯ СТРУКТУРА CLOSER
// =============================================================================

// Closer управляет процессом graceful shutdown приложения.
// Обеспечивает thread-safe регистрацию и выполнение функций завершения.
type Closer struct {
...
// =============================================================================
// ГЛОБАЛЬНЫЙ ЭКЗЕМПЛЯР И ПАКЕТНЫЕ ФУНКЦИИ
// =============================================================================
