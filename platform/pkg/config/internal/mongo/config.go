...
var _ contracts.MongoConfig = (*Config)(nil)
...
// Config публичная структура MongoDB конфигурации с Primary-Replica
type Config struct {
	raw          rawConfig
...
func (c *Config) Pool() contracts.MongoPoolConfig { return c.poolSettings }
